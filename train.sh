...
CKPT_DIR=${CKPT_DIR:-/mnt/ali-sh-1/usr/lihaitao/chenguo/checkpoints/qwen2.5-7b-sum-outcome-warm}
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='verl_sum_outcome' \
    trainer.experiment_name='7b-sum-outcome' \
